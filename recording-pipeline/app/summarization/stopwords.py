"""Small bundled English stopword list. Deliberately not NLTK's corpus -
that requires a runtime download, which would make tests depend on
network access. Good enough for meeting-transcript-style text."""
...
STOPWORDS = frozenset(
    ...
    so than too very s t can will just don should now is am are was were
    be been being have has had having do does did doing would could
    ...
    where's why's how's this that these those i me my myself we our ours
